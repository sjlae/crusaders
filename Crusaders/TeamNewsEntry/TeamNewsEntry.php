...
class TeamNewsEntry extends HTMLPage implements Page{
	...
	private function createNews(){
		...
		$query = "Insert into teamnews(userfsid, teamfsid, titel, text) values('".$userid."', '".$teamid."', '".$this->titel."', '".$this->text."')";
	...
	public function getHTML() {
		include('layout/teamNewsEntry.tpl');
	}
}
