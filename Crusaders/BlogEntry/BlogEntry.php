...
class BlogEntry extends HTMLPage implements Page{
	...
	private function createBlog(){
		...
		$query = "Insert into blog(userfsid, titel, text) values('".$userid."', '".$this->titel."', '".$this->text."')";
